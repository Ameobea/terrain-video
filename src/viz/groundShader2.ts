...
export const buildGroundShader = (
  ...
  uniforms.normalScale = { type: "v2", value: new THREE.Vector2(5.5, 5.5) };
...
#include <clipping_planes_pars_fragment>
    ...
    void main() {
      ...
      vec3 mountainColor = vec3(0.18, 0.18, 0.18);
      vec3 mountainColor2 = vec3(0.155, 0.155, 0.1552);
      ...
      if (offsetHeight > mountainCutoff - 50.) {
        ...
        float terrainNoise = pow(fbm(vec3(pos.x * 0.03, pos.y * 0.010, pos.z * 0.019) * 0.5) * 2.8, 2.);
        vec3 mixedMountainColor = mix(mountainColor, mountainColor2, terrainNoise);
